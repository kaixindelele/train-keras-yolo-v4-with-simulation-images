...
from yolo_utils.utils import get_random_data,get_random_data_with_Mosaic,rand,WarmUpCosineDecayScheduler
...
if __name__ == "__main__":
    ...
    # annotation_path = '/home/lyl/Documents/yolov4-tf2-master/robosuite_save_data/connect_dataset/VOCdevkit/VOC2007/ImageSets/Main/train.txt'
    # 获取classes和anchor的位置
    ...
    #   预测的东西都不一样了自然维度不匹配
    #------------------------------------------------------#
    weights_path = 'model_data/yolo4_keras_weight.h5'
    # weights_path = '/home/lyl/Documents/yolov4-keras-master/logs/ep003-loss38.725-val_loss36.803.h5'
    # 获得classes和anchor
