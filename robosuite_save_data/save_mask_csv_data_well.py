...
def run(args, logs_path=None):
    ...
    array2voc = Array2voc(saved_path="/home/lyl/yolo_data/VOC_more_csv/VOC2007/")
    ...
    for i in range(args.max_episode*2):
        ...
        for j in range(args.max_step*2):
            ...
            try:
                ...
                cv2.imwrite(img_save_path, image_save)
            except Exception as e:
                print("save_e:", e)
                continue
...
def main():
    ...
    parser.add_argument('--max_episode', type=str, default=3)
